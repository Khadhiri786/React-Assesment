...
type StudentDetailsProps = {
  ...
  onSubmit:(e: any) => void;
  particularStudentDetails?:any;
};

const EditStudent: React.FC<StudentDetailsProps> = (
  props: StudentDetailsProps
) => {
    const {particularStudentDetails} = props;
  const [studentDetails, setStudentDetails] = useState({
    studentname: particularStudentDetails?.studentname,
    course: particularStudentDetails?.course,
    departmentid: particularStudentDetails?.departmentid,
    specialization: particularStudentDetails?.specialization,
    percentage: particularStudentDetails?.percentage,
  });
      ...
      <CardContent style={{ textAlign: "center" }}>
        <form name="addStudent">
          <TextField
            label="Student Name"
            required
            defaultValue={particularStudentDetails?.studentname}
          ...
          <TextField
            ...
            required
            name="course"
            defaultValue={particularStudentDetails?.course}
          ...
          <Select
            ...
            defaultValue={particularStudentDetails?.departmentid}
          ...
          <TextField
            ...
            required
            defaultValue={particularStudentDetails?.specialization}
          ...
          <TextField
            label="Percentage"
            required
            defaultValue={particularStudentDetails?.percentage}
